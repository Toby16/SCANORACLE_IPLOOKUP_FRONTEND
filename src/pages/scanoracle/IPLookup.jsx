...
function GhostIPLogo({ size = 120, animated = true }) {
  return (
    ...
    >
      ...
      <line x1="60" y1="45" x2="60" y2="70" stroke="#22c7e0" strokeWidth="5" strokeLinecap="round" />
      {/* Plus cross — horizontal bar */}
      <line x1="48" y1="55" x2="72" y2="55" stroke="#22c7e0" strokeWidth="5" strokeLinecap="round" />
    </svg>
  )
}
